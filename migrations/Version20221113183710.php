 ...
 */
final class Version20221113183710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX created_At ON cctp');
        $this->addSql('ALTER TABLE cctp DROP FOREIGN KEY cctp_ibfk_4');
        $this->addSql('ALTER TABLE cctp ADD num_affaire INT NOT NULL, CHANGE nom_operation nom_operation VARCHAR(255) NOT NULL, CHANGE created_At created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('DROP INDEX utilisateur_id ON cctp');
        $this->addSql('CREATE INDEX IDX_59103F46FB88E14F ON cctp (utilisateur_id)');
        $this->addSql('ALTER TABLE cctp ADD CONSTRAINT cctp_ibfk_4 FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE cctp_lot DROP FOREIGN KEY cctp_lot_ibfk_2');
        $this->addSql('ALTER TABLE cctp_lot DROP FOREIGN KEY cctp_lot_ibfk_1');
        $this->addSql('ALTER TABLE cctp_lot DROP FOREIGN KEY cctp_lot_ibfk_2');
        $this->addSql('ALTER TABLE cctp_lot DROP FOREIGN KEY cctp_lot_ibfk_1');
        ...
        $this->addSql('ALTER TABLE cctp_lot ADD CONSTRAINT cctp_lot_ibfk_2 FOREIGN KEY (lot_id) REFERENCES lot (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cctp_lot ADD CONSTRAINT cctp_lot_ibfk_1 FOREIGN KEY (cctp_id) REFERENCES cctp (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cctp_entreprise DROP FOREIGN KEY cctp_entreprise_ibfk_2');
        $this->addSql('ALTER TABLE cctp_entreprise DROP FOREIGN KEY cctp_entreprise_ibfk_1');
        ...
        $this->addSql('DROP INDEX cctp_entreprise_ibfk_2 ON cctp_entreprise');
        $this->addSql('CREATE INDEX IDX_2FFEAA9DA4AEAFEA ON cctp_entreprise (entreprise_id)');
        $this->addSql('ALTER TABLE cctp_entreprise ADD CONSTRAINT cctp_entreprise_ibfk_2 FOREIGN KEY (entreprise_id) REFERENCES entreprise (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE chantier DROP FOREIGN KEY chantier_ibfk_1');
        $this->addSql('ALTER TABLE chantier DROP Num_affaire');
        $this->addSql('DROP INDEX typeusage_id ON chantier');
        $this->addSql('CREATE INDEX IDX_636F27F67D396812 ON chantier (typeusage_id)');
        $this->addSql('ALTER TABLE chantier ADD CONSTRAINT chantier_ibfk_1 FOREIGN KEY (typeusage_id) REFERENCES typeusage (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('DROP INDEX installeur_id ON devis');
        $this->addSql('ALTER TABLE devis DROP FOREIGN KEY devis_ibfk_3');
        $this->addSql('ALTER TABLE devis DROP FOREIGN KEY devis_ibfk_1');
        $this->addSql('ALTER TABLE devis DROP FOREIGN KEY devis_ibfk_4');
        ...
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT devis_ibfk_3 FOREIGN KEY (chantier_id) REFERENCES chantier (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT devis_ibfk_1 FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE devis ADD CONSTRAINT devis_ibfk_4 FOREIGN KEY (entreprise_id) REFERENCES entreprise (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE doc_final DROP FOREIGN KEY doc_final_ibfk_2');
        $this->addSql('DROP INDEX cctp_id ON doc_final');
        $this->addSql('ALTER TABLE doc_final DROP FOREIGN KEY doc_final_ibfk_1');
        $this->addSql('DROP INDEX produit_id ON doc_final');
        $this->addSql('CREATE INDEX IDX_833C3190F347EFB ON doc_final (produit_id)');
        $this->addSql('ALTER TABLE doc_final ADD CONSTRAINT doc_final_ibfk_1 FOREIGN KEY (produit_id) REFERENCES produit (id)');
        $this->addSql('ALTER TABLE entreprise CHANGE num_rue_entreprise num_rue_entreprise VARCHAR(50) NOT NULL, CHANGE nom_rue_entreprise nom_rue_entreprise VARCHAR(100) NOT NULL, CHANGE cp_entreprise cp_entreprise VARCHAR(50) NOT NULL, CHANGE ville_entreprise ville_entreprise VARCHAR(100) NOT NULL');
        $this->addSql('DROP INDEX entreprise_id ON installeur');
        ...
        $this->addSql('ALTER TABLE lignedevis DROP FOREIGN KEY lignedevis_ibfk_2');
        $this->addSql('ALTER TABLE lignedevis DROP FOREIGN KEY lignedevis_ibfk_3');
        ...
        $this->addSql('ALTER TABLE lignedevis ADD CONSTRAINT lignedevis_ibfk_2 FOREIGN KEY (devis_id) REFERENCES devis (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE lignedevis ADD CONSTRAINT lignedevis_ibfk_3 FOREIGN KEY (produit_id) REFERENCES produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('DROP INDEX id_entreprise ON moa');
        $this->addSql('ALTER TABLE moa DROP entreprise_id, CHANGE tel_moa tel_moa VARCHAR(50) NOT NULL');
        $this->addSql('DROP INDEX id_entreprise ON moe');
        $this->addSql('ALTER TABLE moe DROP entreprise_id');
        $this->addSql('ALTER TABLE optionnel DROP FOREIGN KEY optionnel_ibfk_1');
        ...
        $this->addSql('ALTER TABLE optionnel ADD CONSTRAINT optionnel_ibfk_1 FOREIGN KEY (categorie_id) REFERENCES categorie (id)');
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT produit_ibfk_3 FOREIGN KEY (systeme_id) REFERENCES systeme (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT produit_ibfk_2 FOREIGN KEY (lot_id) REFERENCES lot (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE produit_cctp DROP FOREIGN KEY produit_cctp_ibfk_2');
        $this->addSql('ALTER TABLE produit_cctp DROP FOREIGN KEY produit_cctp_ibfk_1');
        ...
        $this->addSql('ALTER TABLE produit_cctp ADD CONSTRAINT produit_cctp_ibfk_2 FOREIGN KEY (produit_id) REFERENCES produit (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE produit_cctp ADD CONSTRAINT produit_cctp_ibfk_1 FOREIGN KEY (cctp_id) REFERENCES cctp (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('DROP INDEX utilisateur_id ON reset_password_request');
        $this->addSql('CREATE INDEX IDX_7CE748AA76ED395 ON reset_password_request (user_id)');
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT reset_password_request_ibfk_1 FOREIGN KEY (user_id) REFERENCES utilisateur (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE specification DROP FOREIGN KEY specification_ibfk_1');
        ...
        $this->addSql('ALTER TABLE specification ADD CONSTRAINT specification_ibfk_1 FOREIGN KEY (produit_id) REFERENCES produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE systeme_lot DROP FOREIGN KEY systeme_lot_ibfk_2');
        $this->addSql('ALTER TABLE systeme_lot DROP FOREIGN KEY systeme_lot_ibfk_1');
        $this->addSql('ALTER TABLE systeme_lot DROP FOREIGN KEY systeme_lot_ibfk_2');
        $this->addSql('ALTER TABLE systeme_lot DROP FOREIGN KEY systeme_lot_ibfk_1');
        $this->addSql('ALTER TABLE systeme_lot ADD PRIMARY KEY (systeme_id, lot_id)');
        ...
        $this->addSql('DROP INDEX id_systeme ON systeme_lot');
        $this->addSql('CREATE INDEX IDX_BCB72330346F772E ON systeme_lot (systeme_id)');
        $this->addSql('DROP INDEX id_lot ON systeme_lot');
        $this->addSql('CREATE INDEX IDX_BCB72330A8CBA5F7 ON systeme_lot (lot_id)');
        $this->addSql('ALTER TABLE systeme_lot ADD CONSTRAINT systeme_lot_ibfk_2 FOREIGN KEY (systeme_id) REFERENCES systeme (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE systeme_lot ADD CONSTRAINT systeme_lot_ibfk_1 FOREIGN KEY (lot_id) REFERENCES lot (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE typeusage DROP FOREIGN KEY typeusage_ibfk_1');
        $this->addSql('ALTER TABLE typeusage CHANGE color color VARCHAR(7) DEFAULT NULL');
        $this->addSql('DROP INDEX catusage_id ON typeusage');
        $this->addSql('CREATE INDEX IDX_5AC1EB6375A985B1 ON typeusage (catusage_id)');
        $this->addSql('ALTER TABLE typeusage ADD CONSTRAINT typeusage_ibfk_1 FOREIGN KEY (catusage_id) REFERENCES catusage (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE utilisateur CHANGE email email VARCHAR(180) NOT NULL, CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie CHANGE nom_categorie nom_categorie VARCHAR(100) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
        $this->addSql('ALTER TABLE catusage CHANGE nom_catusage nom_catusage VARCHAR(50) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
        $this->addSql('ALTER TABLE cctp DROP FOREIGN KEY FK_59103F46FB88E14F');
        $this->addSql('ALTER TABLE cctp DROP num_affaire, CHANGE titre titre VARCHAR(150) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE nom_operation nom_operation VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, CHANGE created_at created_At DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('CREATE INDEX created_At ON cctp (created_At)');
        $this->addSql('DROP INDEX idx_59103f46fb88e14f ON cctp');
        $this->addSql('CREATE INDEX utilisateur_id ON cctp (utilisateur_id)');
        ...
        $this->addSql('ALTER TABLE cctp_entreprise DROP FOREIGN KEY FK_2FFEAA9DA4AEAFEA');
        $this->addSql('ALTER TABLE cctp_entreprise ADD CONSTRAINT cctp_entreprise_ibfk_2 FOREIGN KEY (entreprise_id) REFERENCES entreprise (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cctp_entreprise ADD CONSTRAINT cctp_entreprise_ibfk_1 FOREIGN KEY (cctp_id) REFERENCES cctp (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('CREATE INDEX cctp_id ON cctp_entreprise (cctp_id, entreprise_id)');
        $this->addSql('DROP INDEX idx_2ffeaa9da4aeafea ON cctp_entreprise');
        $this->addSql('CREATE INDEX cctp_entreprise_ibfk_2 ON cctp_entreprise (entreprise_id)');
        $this->addSql('ALTER TABLE cctp_entreprise ADD CONSTRAINT FK_2FFEAA9DA4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES entreprise (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE chantier ADD Num_affaire INT NOT NULL, CHANGE nom_chantier nom_chantier VARCHAR(100) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE type_lgt type_lgt VARCHAR(50) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`');
        ...
        $this->addSql('CREATE INDEX installeur_id ON devis (installeur_id)');
        ...
        $this->addSql('ALTER TABLE doc_final ADD CONSTRAINT doc_final_ibfk_2 FOREIGN KEY (cctp_id) REFERENCES cctp (id) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('CREATE INDEX entreprise_id ON installeur (entreprise_id)');
        ...
        $this->addSql('ALTER TABLE lot CHANGE nom_lot nom_lot VARCHAR(100) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
        ...
        $this->addSql('CREATE INDEX id_entreprise ON moa (entreprise_id)');
        ...
        $this->addSql('CREATE INDEX id_entreprise ON moe (entreprise_id)');
        ...
        $this->addSql('ALTER TABLE reset_password_request DROP FOREIGN KEY FK_7CE748AA76ED395');
        $this->addSql('ALTER TABLE reset_password_request CHANGE selector selector VARCHAR(20) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE hashed_token hashed_token VARCHAR(100) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE requested_at requested_at DATETIME NOT NULL, CHANGE expires_at expires_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT reset_password_request_ibfk_1 FOREIGN KEY (user_id) REFERENCES utilisateur (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('DROP INDEX idx_7ce748aa76ed395 ON reset_password_request');
        $this->addSql('CREATE INDEX utilisateur_id ON reset_password_request (user_id)');
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE systeme CHANGE nom_systeme nom_systeme VARCHAR(100) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
        ...
        $this->addSql('ALTER TABLE systeme_lot DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE systeme_lot DROP FOREIGN KEY FK_BCB72330346F772E');
        $this->addSql('ALTER TABLE systeme_lot DROP FOREIGN KEY FK_BCB72330A8CBA5F7');
        $this->addSql('ALTER TABLE systeme_lot ADD CONSTRAINT systeme_lot_ibfk_2 FOREIGN KEY (systeme_id) REFERENCES systeme (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE systeme_lot ADD CONSTRAINT systeme_lot_ibfk_1 FOREIGN KEY (lot_id) REFERENCES lot (id) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('DROP INDEX idx_bcb72330a8cba5f7 ON systeme_lot');
        $this->addSql('CREATE INDEX id_lot ON systeme_lot (lot_id)');
        $this->addSql('DROP INDEX idx_bcb72330346f772e ON systeme_lot');
        $this->addSql('CREATE INDEX id_systeme ON systeme_lot (systeme_id)');
        $this->addSql('ALTER TABLE systeme_lot ADD CONSTRAINT FK_BCB72330346F772E FOREIGN KEY (systeme_id) REFERENCES systeme (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE systeme_lot ADD CONSTRAINT FK_BCB72330A8CBA5F7 FOREIGN KEY (lot_id) REFERENCES lot (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE typeusage DROP FOREIGN KEY FK_5AC1EB6375A985B1');
        $this->addSql('ALTER TABLE typeusage CHANGE nom_usage nom_usage VARCHAR(50) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE color color VARCHAR(7) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE email email VARCHAR(100) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`, CHANGE password password VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE nom_user nom_user VARCHAR(50) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, CHANGE prenom_user prenom_user VARCHAR(50) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`');
    }
}
